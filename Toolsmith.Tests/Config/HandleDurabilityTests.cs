...
public class HandleDurabilityTests {
    ...
    public void HandleDurabilityDependsOnlyOnHandlePartsAndMaterial() {
        var onOneTool = ToolsmithPartStatsHelpers.CalculateHandleDurability(
            StatFixtures.Metal(), StatFixtures.NoTreatment(), StatFixtures.NoBinding(), StatFixtures.Copper());
        var onAnother = ToolsmithPartStatsHelpers.CalculateHandleDurability(
            StatFixtures.Metal(), StatFixtures.NoTreatment(), StatFixtures.NoBinding(), StatFixtures.Copper());
    ...
    public void MetalHandleDurabilityMatchesItsMetalDensity(float densityFactor, float expected) {
        ...
        var durability = ToolsmithPartStatsHelpers.CalculateHandleDurability(
    ...
    public void ProfessionalOakHandleDurability() {
        Assert.Equal(1650f, ToolsmithPartStatsHelpers.CalculateHandleDurability(
    ...
    public void CarvedOakHandleDurability() {
        Assert.Equal(1260f, ToolsmithPartStatsHelpers.CalculateHandleDurability(
    ...
    public void StickHandleDurability() {
        Assert.Equal(600f, ToolsmithPartStatsHelpers.CalculateHandleDurability(
    ...
    public void DensityScalesDurabilityProportionally() {
        var atOak = ToolsmithPartStatsHelpers.CalculateHandleDurability(
            StatFixtures.Carved(), StatFixtures.NoTreatment(), StatFixtures.NoBinding(), StatFixtures.Material(1.0f, 0f, 0f));
        var atDouble = ToolsmithPartStatsHelpers.CalculateHandleDurability(
    ...
    public void TreatmentAndBindingBonusesCompoundRatherThanAdd() {
        ...
        Assert.Equal(ToolsmithConstants.PartDurabilityBase * 2.25f, durability, Tolerance);
    }
