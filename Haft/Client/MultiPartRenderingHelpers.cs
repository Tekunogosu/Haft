...
namespace Haft.Client {
    public static class MultiPartRenderingHelpers {
        ...
        public static ITreeAttribute GetMultiPartRenderTree(this ItemStack item) { //Can be iterated through with a foreach loop to process all the parts!
            if (!item.Attributes.HasAttribute(HaftAttributes.ModularMultiPartDataTree)) {
                item.Attributes.GetOrAddTreeAttribute(HaftAttributes.ModularMultiPartDataTree);
            }
            return item.Attributes.GetTreeAttribute(HaftAttributes.ModularMultiPartDataTree);
        }

        public static void SetMultiPartRenderTree(this ItemStack item, ITreeAttribute tree) {
            item.Attributes[HaftAttributes.ModularMultiPartDataTree] = tree;
        }

        public static bool HasMultiPartRenderTree(this ItemStack item) {
            return item.Attributes.HasAttribute(HaftAttributes.ModularMultiPartDataTree);
        }

        public static void RemoveMultiPartRenderTree(this ItemStack item) {
            item.Attributes.RemoveAttribute(HaftAttributes.ModularMultiPartDataTree);
        }

        public static void SetBundleHasGenericParts(this ItemStack item) {
            item.Attributes.SetBool(HaftAttributes.BundleHasGenericParts, true);
        }

        public static bool HasBundleHasGenericParts(this ItemStack item) {
            return item.Attributes.HasAttribute(HaftAttributes.BundleHasGenericParts);
        }

        public static void RemoveBundleHasGenericParts(this ItemStack item) {
            item.Attributes.RemoveAttribute(HaftAttributes.BundleHasGenericParts);
        }
        ...
        public static ITreeAttribute GetPartRenderTree(this ItemStack item) { //Will only contain a specific set of entries! Only set to this on the individual parts themselves! When part of a tool, will just be a tag respective and handled by that tool's Behavior.
            if (!item.Attributes.HasAttribute(HaftAttributes.ModularPartDataTree)) {
                item.Attributes.GetOrAddTreeAttribute(HaftAttributes.ModularPartDataTree);
            }
            return item.Attributes.GetTreeAttribute(HaftAttributes.ModularPartDataTree);
        }

        public static ITreeAttribute GetPartRenderTree(this ITreeAttribute tree) {
            if (!tree.HasAttribute(HaftAttributes.ModularPartDataTree)) {
                tree.GetOrAddTreeAttribute(HaftAttributes.ModularPartDataTree);
            }
            return tree.GetTreeAttribute(HaftAttributes.ModularPartDataTree);
        }

        public static void SetPartRenderTree(this ItemStack item, ITreeAttribute tree) {
            item.Attributes[HaftAttributes.ModularPartDataTree] = tree;
        }

        public static void SetPartRenderTree(this ITreeAttribute main, ITreeAttribute toAdd) {
            main[HaftAttributes.ModularPartDataTree] = toAdd;
        }

        public static bool HasPartRenderTree(this ItemStack item) {
            return item.Attributes.HasAttribute(HaftAttributes.ModularPartDataTree);
        }

        public static bool HasPartRenderTree(this ITreeAttribute tree) {
            return tree.HasAttribute(HaftAttributes.ModularPartDataTree);
        }

        public static void RemovePartRenderTree(this ItemStack item) {
            item.Attributes.RemoveAttribute(HaftAttributes.ModularPartDataTree);
        }

        public static string GetPartShapePath(this ITreeAttribute tree) {
            var shapeString = tree.GetString(HaftAttributes.ModularPartShapeIndex);
            if (shapeString == "haft:shapes/item/gripfabric") {
                shapeString = "haft:shapes/item/parts/handles/grips/gripfabric";
                tree.SetString(HaftAttributes.ModularPartShapeIndex, shapeString);
            } else if (shapeString == "haft:shapes/item/crudehandle") {
                shapeString = "haft:shapes/item/parts/handles/crudehandle";
                tree.SetString(HaftAttributes.ModularPartShapeIndex, shapeString);
            } else if (shapeString == "haft:shapes/item/handle") {
                shapeString = "haft:shapes/item/parts/handles/handle";
                tree.SetString(HaftAttributes.ModularPartShapeIndex, shapeString);
            } else if (shapeString == "haft:shapes/item/carpentedhandle") {
                shapeString = "haft:shapes/item/parts/handles/carpentedhandle";
                tree.SetString(HaftAttributes.ModularPartShapeIndex, shapeString);
            }
            return shapeString;
        }
        ...
        public static void SetPartShapePath(this ITreeAttribute tree, string path) { //This is only set when the part has an alternate shape, otherwise just use the Item Default.
            tree.SetString(HaftAttributes.ModularPartShapeIndex, path);
        }

        public static bool HasPartShapePath(this ITreeAttribute tree) {
            return tree.HasAttribute(HaftAttributes.ModularPartShapeIndex);
        }

        public static string GetShapeOverrideTag(this ITreeAttribute tree) {
            return tree.GetString(HaftAttributes.ShapeOverrideAppendTag);
        }

        public static void SetShapeOverrideTag(this ITreeAttribute tree, string append) {
            tree.SetString(HaftAttributes.ShapeOverrideAppendTag, append);
        }

        public static bool HasShapeOverrideTag(this ITreeAttribute tree) {
            return tree.HasAttribute(HaftAttributes.ShapeOverrideAppendTag);
        }

        public static ITreeAttribute GetPartTextureTree(this ITreeAttribute tree) {
            if (!tree.HasAttribute(HaftAttributes.ModularPartTextureTree)) {
                tree.GetOrAddTreeAttribute(HaftAttributes.ModularPartTextureTree);
            }
            return tree.GetTreeAttribute(HaftAttributes.ModularPartTextureTree);
        }

        public static void SetPartTextureTree(this ITreeAttribute main, ITreeAttribute toAdd) {
            main[HaftAttributes.ModularPartTextureTree] = toAdd;
        }
        ...
        public static string ConvertFromHandlePathToShapePath(string handlePath, string tool) {
            ...
            if (!HaftModSystem.Api.Assets.Exists(new AssetLocation(retVal + ".json"))) { //This IDEALLY should never happen, but just in case it's here as a backup.
                retVal = "haft:shapes/item/parts/" + tool + "/handles/universal/handle";
            }
        ...
        public static string ConvertFromGenericHandlePathToGripShapePath(string handlePath, string grip) {
            ...
            if (!HaftModSystem.Api.Assets.Exists(new AssetLocation(retVal + ".json"))) {
                retVal = "haft:shapes/item/parts/handles/universal/grip/" + grip;
            }
        ...
        public static string ConvertFromHandlePathToGripShapePath(string handlePath, string gripPath, string tool) {
            ...
            if (!HaftModSystem.Api.Assets.Exists(new AssetLocation(retVal + ".json"))) {
                retVal = "haft:shapes/item/parts/" + tool + "/handles/universal/grip/" + gripType;
            }
        ...
        public static string ConvertFromGenericHandlePathToBindingShapePath(string handlePath, string binding, string tool, bool isMetalMat) {
            ...
            if (!HaftModSystem.Api.Assets.Exists(new AssetLocation(retVal + ".json"))) {
                retVal = "haft:shapes/item/parts/" + tool + "/handles/universal/binding/" + bindingString;
            }
        ...
        public static string ConvertFromTypedHandlePathToBindingShapePath(string handlePath, string binding, bool isMetalMat) {
            ...
            if (!HaftModSystem.Api.Assets.Exists(new AssetLocation(retVal + ".json"))) {
                retVal = "haft:shapes/item/parts/" + splitHandle[3] + "/handles/universal/binding/" + bindingString;
            }
        ...
        public static void BuildToolRenderFromAllSeparateParts(ItemStack tool, ItemStack head, ItemStack handle, ItemStack binding = null) {
            ...
            HandlePartDefines handleStats = HaftModSystem.Stats.BaseHandleParts.TryGetValue(handle.Collectible.Code.Path);
            ...
            if (!successfulBindingAdd && HaftModSystem.ToolsWithWoodInBindingShapes.Contains(toolType)) {
        ...
        public static void BuildToolRenderFromHeadAndHandle(ItemStack tool, ItemStack head, ItemStack handle, string toolType = null, string toolSpecificHandleShape = null) {
            ...
            var headPartAndTransformTree = toolMultiPartTree.GetPartAndTransformRenderTree(HaftAttributes.ModularPartHeadName);
            var handlePartAndTransformTree = toolMultiPartTree.GetPartAndTransformRenderTree(HaftAttributes.ModularPartHandleName);
            ...
            if (HaftModSystem.Api.Side.IsServer()) {
                ...
                if (success) {
                    ...
                    HaftModSystem.Logger.Error("Could not find the tool head's ToolHeadTextureData entry when crafting a Part Bundle. Might not render right.");
                }
            } else {
            ...
            toolMultiPartTree.SetPartAndTransformRenderTree(HaftAttributes.ModularPartHeadName, headPartAndTransformTree);
            ...
            if (handle.HasMultiPartRenderTree()) {
                ...
                foreach (var tree in handleMultiPartTree) {
                    ...
                    if (tree.Key == HaftAttributes.ModularPartHandleName && toolSpecificHandleShape != null) {
                    ...
                    } else if (tree.Key == HaftAttributes.ModularPartGripName && toolType != null) {
                ...
                toolMultiPartTree.SetPartAndTransformRenderTree(HaftAttributes.ModularPartHandleName, handlePartAndTransformTree);
                handle.GetMultiPartRenderTree().SetPartAndTransformRenderTree(HaftAttributes.ModularPartHandleName, handlePartAndTransformTree);
            }
        ...
        public static bool AddBindingToExistingToolRender(ItemStack tool, ItemStack binding, string toolType = null) {
            BindingPartDefines bindingPart = HaftModSystem.Stats.BindingParts.TryGetValue(binding.Collectible.Code.Path);
            ...
            BindingStatDefines bindingStats = HaftModSystem.Stats.BindingStats.TryGetValue(bindingPart.bindingStatTag);

            var toolMultiPartTree = tool.GetMultiPartRenderTree();
            if (toolType == null) {
                toolType = GetToolTypeFromHeadShapePath(toolMultiPartTree.GetPartAndTransformRenderTree(HaftAttributes.ModularPartHeadName).GetPartRenderTree().GetPartShapePath());
            }

            var bindingTransformAndPartTree = toolMultiPartTree.GetPartAndTransformRenderTree(HaftAttributes.ModularPartBindingName);
            ...
            if (toolMultiPartTree.HasPartAndTransformRenderTree(HaftAttributes.ModularPartHandleName)) {
                var handlePartTree = toolMultiPartTree.GetPartAndTransformRenderTree(HaftAttributes.ModularPartHandleName).GetPartRenderTree();
            ...
            toolMultiPartTree.SetPartAndTransformRenderTree(HaftAttributes.ModularPartBindingName, bindingTransformAndPartTree);
            tool.SetMultiPartRenderTree(toolMultiPartTree);
        ...
        public static void AddWoodPartsOfBindingToExistingToolRender(ItemStack tool) { //Assumes a default of 'string' for which binding to include the wood parts from.
            ...
            if (toolMultiPartTree.HasPartAndTransformRenderTree(HaftAttributes.ModularPartHandleName)) {
                var handleTree = toolMultiPartTree.GetPartAndTransformRenderTree(HaftAttributes.ModularPartHandleName).GetPartRenderTree();
