...
namespace Haft.Compat {
    ...
    //Everything Haft knows about CAN Jewelry. That mod encrusts gems into tools and keeps the sockets in an
    //attribute tree on the stack; Haft has to carry that tree across whenever a tool becomes parts or parts
