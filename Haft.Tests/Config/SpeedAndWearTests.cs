...
public class SpeedAndWearTests {
    ...
    public void MetalHandleSpeedComesFromItsMetal(float materialSpeedBonus, float expected) {
        var speed = HaftPartStatsHelpers.CalculateSpeedBonus(
    ...
    public void WoodenHandleSpeedComesFromItsTier() {
        Assert.Equal(0.1f, HaftPartStatsHelpers.CalculateSpeedBonus(
            StatFixtures.Professional(), StatFixtures.PlainGrip(), StatFixtures.Oak()), Tolerance);
        Assert.Equal(0.05f, HaftPartStatsHelpers.CalculateSpeedBonus(
    ...
    public void OmittingTheMaterialLeavesHandleAndGripUnchanged() {
        ...
        var withoutMaterial = HaftPartStatsHelpers.CalculateSpeedBonus(StatFixtures.Professional(), grip);
        var withNeutral = HaftPartStatsHelpers.CalculateSpeedBonus(
    ...
    public void GripAndTreatmentSavesMultiplyRatherThanAdd() {
        var chance = HaftPartStatsHelpers.CalculateGripChanceToDamage(
    ...
    public void NoTreatmentLeavesTheGripChanceAlone() {
        ...
        Assert.Equal(0.7f, HaftPartStatsHelpers.CalculateGripChanceToDamage(grip), Tolerance);
        Assert.Equal(0.7f, HaftPartStatsHelpers.CalculateGripChanceToDamage(grip, StatFixtures.NoTreatment()), Tolerance);
    }
}
